...
func Recommend(env model.Environment) []model.Recommendation {
	recs := []model.Recommendation{
		...
		{Protocol: "hysteria2", Transport: "quic", Security: "tls", Priority: 5, Label: "高速传输", Description: "需要域名证书，证书接入后开启", Enabled: false},
		{Protocol: "trojan-tls", Transport: "tcp", Security: "tls", Priority: 4, Label: "广泛兼容", Description: "需要域名证书，证书接入后开启", Enabled: false},
